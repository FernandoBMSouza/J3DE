...
namespace Name.GameObjects.Name.Letters
{
    class D : GameObject
    {
        public D(Game1 game, Color color, Color colorBorder, bool showColliderLines = false)
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            Children[6].World *= Matrix.CreateTranslation(new Vector3(0, Children[6].Size.Y * 2, 0));

            Children[7].World *= Matrix.CreateTranslation(new Vector3(Children[7].Size.Y * 1, Children[7].Size.Y * 0, 0));
