...
namespace Name.GameObjects.Name.Letters
{
    class R : GameObject
    {
        public R(Game1 game, Color color, Color colorBorder, bool showColliderLines = false)
            : base(game, showColliderLines)
        {
            ...
            for (int i = Children.Length - 3; i < Children.Length; i++)
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            Children[8].World *= Matrix.CreateTranslation(new Vector3(Children[8].Size.Y * 1, Children[8].Size.Y *  1f, 0));

            // Triangles

            Children[9].World *= Matrix.CreateTranslation(new Vector3(Children[9].Size.Y * 1, Children[9].Size.Y * 2, 0));
            Children[10].World *= Matrix.CreateRotationZ(MathHelper.ToRadians(270));
            Children[10].World *= Matrix.CreateTranslation(new Vector3(Children[10].Size.Y * 1, Children[10].Size.Y * 0, 0));
            Children[11].World *= Matrix.CreateTranslation(new Vector3(Children[11].Size.Y * 1, Children[11].Size.Y * -1f, 0));
