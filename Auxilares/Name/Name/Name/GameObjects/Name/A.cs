...
namespace Name.GameObjects.Name
{
    ...
    {
        float speed;
        public A(Game1 game, Vector3 position, Vector3 rotation, Vector3 scale, Color color, bool colliderVisible = true)
            : base(game, position, rotation, scale, colliderVisible)
        {
            ...
            children.Add(new Cube(game, new Vector3(-1, 1, 0), new Vector3(0, 0, 0), new Vector3(1), color, false));
            children.Add(new RightTriangle3D(game, new Vector3(-1, 2, 0), new Vector3(0, 0, 90), new Vector3(1, 1, 1), color, false));
