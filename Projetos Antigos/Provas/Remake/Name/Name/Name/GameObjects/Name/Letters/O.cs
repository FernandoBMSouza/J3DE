...
namespace Name.GameObjects.Name.Letters
{
    class O : GameObject
    {
        public O(Game1 game, Color color, Color colorBorder, bool showColliderLines = false)
            : base(game, showColliderLines)
        {
            ...
            for (int i = Children.Length-4; i < Children.Length; i++)
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            Children[3].World *= Matrix.CreateTranslation(new Vector3(0, Children[3].Size.Y *-2, 0));
            Children[4].World *= Matrix.CreateTranslation(new Vector3(0, Children[4].Size.Y * 2, 0));

            Children[5].World *= Matrix.CreateTranslation(new Vector3(Children[5].Size.Y * 1, Children[5].Size.Y * 0, 0));
            Children[6].World *= Matrix.CreateTranslation(new Vector3(Children[6].Size.Y * 1, Children[6].Size.Y * 1, 0));
            Children[7].World *= Matrix.CreateTranslation(new Vector3(Children[7].Size.Y * 1, Children[7].Size.Y * -1, 0));

            // Triangles
            Children[8].World *= Matrix.CreateRotationZ(MathHelper.ToRadians(270));
            ...
            Children[10].World *= Matrix.CreateRotationZ(MathHelper.ToRadians(180));
            Children[10].World *= Matrix.CreateTranslation(new Vector3(Children[10].Size.Y *-1, Children[10].Size.Y *-2, 0));
            Children[11].World *= Matrix.CreateRotationZ(MathHelper.ToRadians(90));
