...
using Mundo03.GameObjects.Primitives;
...
namespace Mundo03.GameObjects.Windmill
{
    ...
    {
        public Building(Game1 game, Texture2D texture, bool showColliderLines = false)
            : base(game, showColliderLines)
        {
            Children = new GameObject[] 
            { 
                new Cube(game, texture),
                new RightTriangle3D(game, texture),
            };
