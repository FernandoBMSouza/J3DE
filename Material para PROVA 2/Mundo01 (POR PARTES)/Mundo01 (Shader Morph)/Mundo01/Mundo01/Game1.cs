...
namespace Mundo01
{
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            textures.Add(Content.Load<Texture2D>(@"Images\snow"));
            textures.Add(Content.Load<Texture2D>(@"Images\bricksSnow"));
            textures.Add(Content.Load<Texture2D>(@"Images\rocksSnow"));
            textures.Add(Content.Load<Texture2D>(@"Images\woodSnow"));

            effects = new List<Effect>();
            effects.Add(Content.Load<Effect>(@"Effects\basic"));
            effects.Add(Content.Load<Effect>(@"Effects\morphing"));

            camera = new Camera(this);
            go = new List<GameObject>();
            go.Add(new Quad(this, Vector3.Zero, Vector3.Zero, new Vector3(15), effects[1], textures[0], textures[4], colliderVisible));
            go.Add(new Cube(this, new Vector3(0, .5f, 0), Vector3.Zero, Vector3.One, effects[1], textures[1], textures[5], colliderVisible));
            go.Add(new Windmill(this, new Vector3(-5, 1, -3), new Vector3(0, 45, 0), Vector3.One, effects[1], textures[2], textures[3], textures[6], textures[7], colliderVisible));
            go.Add(new Windmill(this, new Vector3(5, 1, -3), new Vector3(0, -45, 0), Vector3.One, effects[1], textures[2], textures[3], textures[6], textures[7], colliderVisible));
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            foreach (GameObject g in go) g.Draw(camera, gameTime);
