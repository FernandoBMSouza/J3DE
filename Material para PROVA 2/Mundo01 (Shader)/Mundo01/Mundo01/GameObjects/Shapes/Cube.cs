...
namespace Mundo01.GameObjects.Shapes
{
    ...
    {
        public Cube(Game1 game, Vector3 position, Vector3 rotation, Vector3 scale, Effect effect, Texture2D texture, Texture2D winterTexture, bool colliderVisible = true)
