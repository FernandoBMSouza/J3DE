...
{
    public class Triangle3DTexture : ShapeTexture
    {
        public Triangle3DTexture(Game1 game, Vector3 position, Vector3 rotation, Vector3 scale, Effect effect, Texture2D texture, bool colliderVisible = true)
